...
export const PARENTS = {
  btc:   { network: 'btc:mainnet',          label: 'Bitcoin mainnet',          family: 'stock',   pow: 'sha256d',
           genesis: '000000000019d6689c085ae165831e934ff763ae46a2a6c172b3f1b60a8ce26f' },
  tbtc4: { network: 'btc:testnet4',         label: 'Bitcoin testnet4',         family: 'stock',   pow: 'sha256d',
           genesis: '00000000da84f2bafbbc53dee25a72ae507ff4914b867c565be350b0da8bf043' },
  xbt:   { network: 'btc:mainnet-blake2b',  label: 'BLAKE2b mainnet (Knots)',  family: 'blake2b', pow: 'blake2b',
           genesis: '000000000019d6689c085ae165831e934ff763ae46a2a6c172b3f1b60a8ce26f',
           fork: { height: 961640, hash: '0000000000000050c1e5f69672f459293be14f46e5a494e7a8c8541396f18eeb' } },
  txbt4: { network: 'btc:testnet4-blake2b', label: 'BLAKE2b testnet4 (Knots)', family: 'blake2b', pow: 'blake2b',
           genesis: '00000000da84f2bafbbc53dee25a72ae507ff4914b867c565be350b0da8bf043',
           fork: { height: 150308, hash: '000000000000b9d1b7e1bb0e77215ee92c6ef7ec8f4473e23908380649e779b6' } },
  ltc:   { network: null, label: 'Litecoin mainnet', family: 'stock', pow: 'scrypt',   reserved: true },
  vtc:   { network: null, label: 'Vertcoin mainnet', family: 'stock', pow: 'verthash', reserved: true },
};
...
export function parentAlias(id) { if (typeof id !== 'string') return null; if (PARENTS[id]) return id; return LONG[id] ?? null; }
